...
public class DownLoad {
    private static String url = null, bookUrl = null, dir = null, bookName = null, deleteWord1 = "", deleteWord2 = "";
    private static int outTime = 0, stepChap=0;
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            path = Thread.currentThread().getContextClassLoader().getResource("para.properties").getPath();
        }catch (Exception e){
            e.printStackTrace();
        ...
        //循环下载
        for (int i = stepChap; i < textArrayList.size(); i++) {
            try {
    ...
    private static void Down(Map map) throws IOException {
